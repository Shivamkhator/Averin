...
import { hash, hashEmail } from "@/lib/crypto";
...
export const authOptions: NextAuthOptions = {
  ...
  `;
    ...
    MicrosoftProvider({
      ...
      authorization: { params: { scope: "User.Read openid email profile" } },
    }),
  ],
        ...
        if (existingUser) {
          ...
          const accountExists = existingUser.accounts.some(
            (acc) =>
              ...
              acc.providerAccountIdHash === hash(account.providerAccountId),
          );
          ...
          if (!accountExists) {
            ...
            await prisma.account.create({
              data: {
                ...
                providerAccountIdHash: hash(account.providerAccountId),
