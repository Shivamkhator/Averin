      ...
      <div className="text-center space-y-2">
        ...
        <div className="flex flex-col">
          <button
            ...
            className="px-4 py-2 mt-6 rounded-lg bg-action text-white text-lg hover:transform hover:scale-105 disabled:opacity-50"
          >
            {isVerifying
              ? "Verifying..."
              : hasPasskeys
          ...
          {hasPasskeys && !isVerifying && (
            <button
              ...
              className="px-4 py-2 mt-2 rounded-lg bg-blue-500 text-white text-lg hover:transform hover:scale-105"
            >
              Add New Passkey
            </button>
          )}
