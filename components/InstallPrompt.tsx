...
export default function InstallPrompt() {
  ...
  return (isIOS && (
    <div
      className="fixed bottom-24 left-1/2 z-999 w-[90%] max-w-sm -translate-x-1/2 rounded-xl bg-action px-4 py-3 text-center text-background shadow-lg animate-in slide-in-from-bottom-3 duration-300"
      role="dialog"
